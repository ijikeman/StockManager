...
class StockServiceTest {
    ...
    val stockInfo = StockInfo(price = 1200.0, incoming = 12.0, earningsDate = java.time.LocalDate.of(2025, 1, 2), previousPrice = 1000.0, priceChange = 200.0, priceChangeRate = 20.0)
    val updatedStock = originalStock.copy(currentPrice = 1200.0, incoming = 12.0, earningsDate = java.time.LocalDate.of(2025, 1, 2), previousPrice = 1000.0, priceChange = 200.0, priceChangeRate = 20.0)
        ...
        assertThat(result?.previousPrice).isEqualTo(1000.0)
        assertThat(result?.priceChange).isEqualTo(200.0)
        assertThat(result?.priceChangeRate).isEqualTo(20.0)
    }
    ...
    val stockInfo1 = StockInfo(price = 1100.0, incoming = 11.0, earningsDate = java.time.LocalDate.of(2025, 1, 11), previousPrice = 1000.0, priceChange = 100.0, priceChangeRate = 10.0)
    val stockInfo2 = StockInfo(price = 2200.0, incoming = 22.0, earningsDate = java.time.LocalDate.of(2025, 2, 12), previousPrice = 2000.0, priceChange = 200.0, priceChangeRate = 10.0)

    val updatedStock1 = stock1.copy(currentPrice = 1100.0, incoming = 11.0, earningsDate = java.time.LocalDate.of(2025, 1, 11), previousPrice = 1000.0, priceChange = 100.0, priceChangeRate = 10.0)
    val updatedStock2 = stock2.copy(currentPrice = 2200.0, incoming = 22.0, earningsDate = java.time.LocalDate.of(2025, 2, 12), previousPrice = 2000.0, priceChange = 200.0, priceChangeRate = 10.0)
