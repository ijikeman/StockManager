...
class StockRepositoryTest {
    ...
    fun `findById should return stock when stock exists`() {
        ...
        val stock = Stock(code = "9999", name = "test stock", current_price = 1000.0, dividend = 10.0, earnings_date = "2025-01-01", sector = persistedSector)
    ...
    fun `save should persist stock`() {
        ...
        val sector = Sector(name = "test sector")
        val persistedSector = entityManager.persist(sector)
        val stock = Stock(code = "9998", name = "new stock", current_price = 2000.0, dividend = 20.0, earnings_date = "2025-01-02", sector = persistedSector)
